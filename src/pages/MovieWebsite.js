...
import Swal from "sweetalert2";
    ...
    return (
        ...
        <form onSubmit={getMoviesHandler} style={{backgroundColor:'white', padding:'20px'}}>
        <input onChange={e=> setText(e.target.value)} className="js-input-flix" placeholder="Search for your favourite Movie" type="text" />
...
<div className="card-body">
  ...
  <p className="card-text">{x.Year} {x.Type}

  </p>
  <a href="#" className="btn btn-danger w-100">see details
